...
public final class ConsulClientTest {
    ...
    public void testCatalogNodes() throws IOException, ExecutionException, InterruptedException {
        ...
        Assert.assertEquals(3, hostList.size());
        Assert.assertEquals("host1.example.com", hostList.get(0).getNode());
        Assert.assertEquals("10.1.0.1", hostList.get(0).getAddress());
        Assert.assertEquals("host2.example.com", hostList.get(1).getNode());
        Assert.assertEquals("10.1.0.12", hostList.get(1).getAddress());
        Assert.assertEquals("host3.example.com", hostList.get(2).getNode());
        Assert.assertEquals("10.1.0.18", hostList.get(2).getAddress());
    }
