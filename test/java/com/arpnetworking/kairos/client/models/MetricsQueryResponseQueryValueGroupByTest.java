...
/**
 * Tests for {@link MetricsQueryResponse.QueryValueGroupBy}.
 *
 * @author Ville Koskela (ville dot koskela at inscopemetrics dot io)
 */
public final class MetricsQueryResponseQueryValueGroupByTest {
    ...
    public void testTranslationLosesNothing() throws Exception {
        SerializationTestUtils.assertTranslationLosesNothing(
                ...
                MetricsQueryResponse.QueryValueGroupBy.class
        );
    }
    ...
    public void testBuilder() throws InvocationTargetException, IllegalAccessException {
        BuildableTestHelper.testBuild(
                new MetricsQueryResponse.QueryValueGroupBy.Builder()
                        .setRangeSize(10)
