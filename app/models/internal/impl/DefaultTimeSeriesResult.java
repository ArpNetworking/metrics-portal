...
public final class DefaultTimeSeriesResult implements TimeSeriesResult {
    @Override
    public MetricsQueryResult getQueryResult() {
        return _queryResult;
    }
    ...
    private final MetricsQueryResult _queryResult;
    ...
    public static final class Builder extends OvalBuilder<TimeSeriesResult> {
         ...
         */
        public Builder setQueryResult(final MetricsQueryResult value) {
            _queryResult = value;
            return this;
        }
        ...
        @NotNull
        private MetricsQueryResult _queryResult;
        @NotNull
