 ...
 */
public abstract class TimeWindowBaseAggregator extends BaseExecution {
    @Override
    public CompletionStage<TimeSeriesResult> executeWithDependencies(final Map<StageExecution, TimeSeriesResult> results) {
        final CompletableFuture<TimeSeriesResult> timeSeriesResultCompletableFuture = new CompletableFuture<>();
        timeSeriesResultCompletableFuture.completeExceptionally(new IllegalStateException("Not Implemented"));
        return timeSeriesResultCompletableFuture;
    }
