...
val appDependencies = Seq(
  ...
  "com.arpnetworking.metrics.extras" % "incubator-extra" % "0.6.2",
...
val main = (project in file(".")).enablePlugins(play.sbt.PlayJava, play.ebean.sbt.PlayEbean, RpmPlugin, SbtAspectj, JavaServerAppPackaging, SystemVPlugin, UniversalPlugin, Antlr4Plugin).settings(
  name := appName,
  s,
